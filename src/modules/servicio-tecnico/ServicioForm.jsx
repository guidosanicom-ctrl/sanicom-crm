    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <select value={form.clienteId} onChange={e => set('clienteId', e.target.value)} className={`w-full px-3 py-2 border ${err('clienteId')} rounded-lg text-sm focus:outline-none`}>
