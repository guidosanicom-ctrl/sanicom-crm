export const USERS = [
  ...
  { id: 'u2', name: 'Javier Govantes', email: 'javiergovantes@sanicom.es', password: 'sanicom2024', role: 'Administración', active: true, avatar: null },
  ...
  { id: 'u4', name: 'Rosso Guido', email: 'guidorosso@sanicom.es', password: 'sanicom2024', role: 'Administración', active: true, avatar: null },
];
...
export const SEED_OPORTUNIDADES = [
  ...
  { id: 'op3', nombre: 'ECG y pulsioxímetros', clienteId: 'c3', equipos: ['e3', 'e6'], valor: 6750, probabilidad: 50, etapa: 'Cualificado', fechaCierre: '2024-04-15', responsable: 'u3', origen: 'Web', descripcion: '1 ECG y 3 pulsioxímetros para el centro de salud.', fechaCreacion: '2024-02-01', fechaUltimaActualizacion: '2024-02-10' },
